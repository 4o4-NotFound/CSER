...
class ConfigRegression():
    def __init__(self, args):
        ...
        merged_config.update(dataArgs)
        merged_config.update(commonArgs)
        merged_config.update(HYPER_MODEL_MAP[model_name]()['datasetParas'][dataset_name])

        self.args = Storage(merged_config)
    ...
    def __datasetCommonParams(self):
        ...
        tmp = {
            ...
            'simsv2': {
                'unaligned': {
                    'dataPath': os.path.join(root_dataset_dir, 'SIMS-V2/SIMS/Processed/ch-simsv2s.pkl'),
